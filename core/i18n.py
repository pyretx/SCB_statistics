...
UI: dict[str, dict[str, str]] = {
    "EN": {
        ...
        "confirm_title": "Confirm your search",
        "confirm_intro": "Check the filters below, then search — or search with the current selection.",
        "confirm_occ": "Occupation",
        "cancel": "Cancel",
        "language": "Language",
        ...
        "tab_region_sim": "By region",
        "rs_intro": "Below are the national figures for the selected occupation. Turn on the simulation to estimate them for a specific region.",
        "rs_toggle": "Simulate a specific region",
        "rs_region": "Region",
        "rs_national": "National",
        "rs_basis": "Regional difference based on {basis}.",
        "rs_disclaimer": "Estimate only. This applies the region's overall pay difference — measured across all occupations — to this one occupation. The true regional gap for this specific occupation may differ.",
        "rs_unavailable": "Regional simulation isn't available for this country.",
        "rs_real_intro": "Below are the national figures for the selected occupation. Choose a state to see its actual regional wages.",
        "rs_real_toggle": "Show a specific state",
        "rs_state": "State",
        "rs_real_note": "Actual BLS OEWS wages by state (all industries). BLS does not publish wages by occupation × industry × state, so an industry selection does not apply here; blank cells are figures BLS suppresses for that state.",
        "m_gap": "F/M gap", "m_headcount": "Headcount",
        "kpi_mean": "Mean salary",
        ...
        "split_sex": "Split by gender",
        "also_known": "Also known as",
        "pop_curve": "All employees",
        "lead_gap_mean_note": "Ranked on mean salary (medians aren't published per gender here).",
        "ov_selected": "employees selected",
        "ov_by_sex": "Mean by gender",
        "ov_employees": "employees",
        "ov_hc_sub": "in this occupation & filter selection",
    ...
    "NO": {
        ...
        "confirm_title": "Bekreft søket",
        "confirm_intro": "Sjekk filtrene under, og søk — eller søk med gjeldende valg.",
        "confirm_occ": "Yrke",
        "cancel": "Avbryt",
        "language": "Språk",
        ...
        "tab_region_sim": "Etter region",
        "rs_intro": "Nedenfor er landstallene for det valgte yrket. Slå på simuleringen for å anslå dem for en bestemt region.",
        "rs_toggle": "Simuler en bestemt region",
        "rs_region": "Region",
        "rs_national": "Hele landet",
        "rs_basis": "Regional forskjell basert på {basis}.",
        "rs_disclaimer": "Kun et anslag. Dette bruker regionens generelle lønnsforskjell — målt på tvers av alle yrker — på dette ene yrket. Den faktiske regionale forskjellen for nettopp dette yrket kan avvike.",
        "rs_unavailable": "Regional simulering er ikke tilgjengelig for dette landet.",
        "m_gap": "K/M-gap", "m_headcount": "Antall ansatte",
        "kpi_mean": "Gjennomsnittslønn",
        ...
        "ov_selected": "ansatte i utvalget",
        "ov_by_sex": "Gjennomsnitt etter kjønn",
        "ov_employees": "ansatte",
        "ov_hc_sub": "i dette yrket og filterutvalget",
    ...
    "SV": {
        ...
        "confirm_title": "Bekräfta sökningen",
        "confirm_intro": "Kontrollera filtren nedan och sök — eller sök med nuvarande val.",
        "confirm_occ": "Yrke",
        "cancel": "Avbryt",
        "language": "Språk",
        ...
        "tab_region_sim": "Efter region",
        "rs_intro": "Nedan visas rikssiffrorna för det valda yrket. Slå på simuleringen för att uppskatta dem för en viss region.",
        "rs_toggle": "Simulera en viss region",
        "rs_region": "Region",
        "rs_national": "Hela riket",
        "rs_basis": "Regional skillnad baserad på {basis}.",
        "rs_disclaimer": "Endast en uppskattning. Detta tillämpar regionens generella löneskillnad — mätt över alla yrken — på detta enda yrke. Den verkliga regionala skillnaden för just detta yrke kan avvika.",
        "rs_unavailable": "Regional simulering är inte tillgänglig för detta land.",
        ...
        "ov_selected": "anställda i urvalet",
        "ov_by_sex": "Medelvärde efter kön",
        "ov_employees": "anställda",
        "ov_hc_sub": "i detta yrke och filterurval",
    ...
    "FR": {
        ...
        "confirm_title": "Confirmer la recherche",
        "confirm_intro": "Vérifiez les filtres ci-dessous, puis lancez la recherche — ou recherchez avec la sélection actuelle.",
        "confirm_occ": "Métier",
        "cancel": "Annuler",
        "language": "Langue",
        ...
        "tab_region_sim": "Par région",
        "rs_intro": "Voici les chiffres nationaux pour le métier sélectionné. Activez la simulation pour les estimer pour une région donnée.",
        "rs_toggle": "Simuler une région donnée",
        "rs_region": "Région",
        "rs_national": "National",
        "rs_basis": "Écart régional basé sur {basis}.",
        "rs_disclaimer": "Estimation seulement. Ceci applique l'écart de rémunération global de la région — mesuré sur l'ensemble des métiers — à ce métier précis. L'écart régional réel pour ce métier peut différer.",
        "rs_unavailable": "La simulation régionale n'est pas disponible pour ce pays.",
        "m_gap": "Écart F/H", "m_headcount": "Effectifs",
        "kpi_mean": "Salaire moyen",
        ...
        "ov_selected": "salariés sélectionnés",
        "ov_by_sex": "Moyenne par sexe",
        "ov_employees": "salariés",
        "ov_hc_sub": "dans ce métier et cette sélection",
