...
UI: dict[str, dict[str, str]] = {
    "EN": {
        ...
        "all_groups": "— All major groups —",
        "sub_group": "2. Sub-group",
        "all_subgroups": "— All sub-groups —",
        "occ_search": "Search occupations…",
        "occupations": "3. Occupation(s)",
    ...
    "NO": {
        ...
        "major_group": "1. Yrkesfelt",
        "all_groups": "— Alle yrkesfelt —",
        "sub_group": "2. Yrkesområde",
        "all_subgroups": "— Alle yrkesområder —",
        "occ_search": "Søk yrker…",
        "occupations": "3. Yrke(r)",
